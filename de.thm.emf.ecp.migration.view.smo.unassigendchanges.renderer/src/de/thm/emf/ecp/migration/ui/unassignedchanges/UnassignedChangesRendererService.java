 ...
 *
 */
public class UnassignedChangesRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (MigrationPackage.eINSTANCE.getMigration_UnassignedChanges().equals(eStructuralFeature)) {
			return 10;
		}
		return NOT_APPLICABLE;
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return UnassignedChangesRenderer.class;
	}
