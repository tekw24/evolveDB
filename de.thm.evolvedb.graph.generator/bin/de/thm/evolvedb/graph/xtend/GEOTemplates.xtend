...
class GEOTemplates {
	 ...
	 */
	def static CharSequence addLabelToNodeOnPath(String labelToAdd, String nodeLabel, String startRelType,
		String endRelType) {
		'''
			Add label «q(labelToAdd)» to node with label «q(nodeLabel)» 
	...
	def static CharSequence deleteLabelFromNodeOnPath(String labelToDelete, String nodeLabel, String startRelType,
		String endRelType) {
		'''
			Delete label «q(labelToDelete)» of node with label «q(nodeLabel)» 
			    starting at relationship with type «q(startRelType)», ending at relationship with type «q(endRelType)»
	...
	def static CharSequence addNodeLabelToNodeType(List<String> nodeTypeLabels, String newLabel) {
		'''
			Add nodelabel «q(newLabel)» to nodetype «FOR s : nodeTypeLabels SEPARATOR ', '»«s»«ENDFOR»
		'''
	}

	/** Rename label ... on path */
	def static CharSequence renameLabelOfNodeOnPath(String oldLabel, String newLabel, String nodeLabel,
		String startRelType, String endRelType) {
		'''
			Rename label «q(oldLabel)» of node with label «q(nodeLabel)» to label «q(newLabel)» 
			    starting at relationship with type «q(startRelType)», ending at relationship with type «q(endRelType)»
		'''
	...
	def static CharSequence addPropertyToNodeOnPath(String propertyName, String nodeLabel, String startRelType,
		String endRelType) {
		'''
			Add property «q(propertyName)» to node with label «q(nodeLabel)» 
			    starting at relationship with type «q(startRelType)», ending at relationship with type «q(endRelType)»
	...
	def static CharSequence renamePropertyOfNodeOnPath(String fromProp, String toProp, String nodeLabel,
		String startRelType, String endRelType) {
		'''
	 ...
	 */
	def static CharSequence renameRelationshipBetween(String oldType, String newType, String startNodeLabel,
		String endNodeLabel) {
		'''
	 ...
	 */
	def static CharSequence copyFeature(String featureKind, String featureName, String fromKind, String fromId,
	 ...
	 */
	def static CharSequence splitElement(String kind, String id, String propertyName, String relationHandling,
		String partALabel, String partBLabel) {
	 ...
	 */
	def static CharSequence keepAllFeaturesJoin(String keepSide, String elementKind, String leftId, String rightId) {
	 ...
	 */
	def static CharSequence copyPropertiesAndDeleteOriginals(String fromKind, String fromId, String toKind, String toId,
