...
public class MigrationPackageImpl extends EPackageImpl implements MigrationPackage {
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(graphPartiallyResolvableOperatorTypeEEnum, GraphPartiallyResolvableOperatorType.REMOVE_PROPERTY_LABEL);
		addEEnumLiteral(graphPartiallyResolvableOperatorTypeEEnum, GraphPartiallyResolvableOperatorType.REMOVE_PROPERTY_EDGE_TYPE);
		addEEnumLiteral(graphPartiallyResolvableOperatorTypeEEnum, GraphPartiallyResolvableOperatorType.REMOVE_PROPERTY_NODE_TYPE);
		addEEnumLiteral(graphPartiallyResolvableOperatorTypeEEnum, GraphPartiallyResolvableOperatorType.BINARY_ENCODING_CHANGE);
		addEEnumLiteral(graphPartiallyResolvableOperatorTypeEEnum, GraphPartiallyResolvableOperatorType.REMOVE_CONSTRAINT);
