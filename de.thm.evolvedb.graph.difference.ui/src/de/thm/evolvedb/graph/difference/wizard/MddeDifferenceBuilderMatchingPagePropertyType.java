...
public class MddeDifferenceBuilderMatchingPagePropertyType extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		listener = new ModifyListener() {
			...
			public void modifyText(ModifyEvent arg0) {
				...
				List<Correspondence> tableCorrespondence = elist.stream()
						.filter(e -> e.getMatchedA() instanceof PropertyValueType).collect(Collectors.toList());
				...
				for (Correspondence correspondence : tableCorrespondence) {
					...
					if (objectA instanceof PropertyValueType) {
						nameA = getPropertyValueTypeName((PropertyValueType) objectA);
						nameB = getPropertyValueTypeName((PropertyValueType) objectB);
		...
		tcUnmatched.setText("Unmatched PropertyValueType");
		tcUnmatched.pack();
...
//					dialog.setMessage("Do you really want to do this?");
	...
	private void addUnmatchedElements(EList<EObject> elistUnmatched) {
		...
		for (EObject e : elistUnmatched) {
			...
			if (e instanceof PropertyValueType) {
				name = getPropertyValueTypeName((PropertyValueType) e);
	...
	private String getPropertyValueTypeName(PropertyValueType propertyValueType) {
